...
class HelperDB {
  ...
  _onCreate(Database db, int version) async {
    ...
    await db
        .execute("CREATE TABLE $TABLE_INCOME ($ID INTEGER PRIMARY KEY, "
        "$NAME_CATEGORY TEXT,"
        "$ACCOUNT INTEGER,"
        "$AMOUNT REAL,"
        "$DATE DATE"
      ...
      var query = "INSERT INTO $TABLE_INCOME_CATEGORY ($NAME_CATEGORY) VALUES ('Зарплата')";
